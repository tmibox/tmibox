...
config :tmibox, TmiboxWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "xM42381Mr5Pt2CprjxTy1CSKbG1gZOWZFo1cJRtGkZj3fV0QzRRj5lbRrtbjpJ9t",
  watchers: [
...
config :tmibox, TmiboxWeb.Endpoint,
  ...
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/tmibox_web/(live|views|components)/.*(ex|sface|js)$",
      ~r"lib/tmibox_web/templates/.*(eex)$",
      ~r"priv/catalogue/.*(ex)$"
    ]
  ]
