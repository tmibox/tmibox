defmodule TmiboxWeb.UserSettingsController do
  ...
  def confirm_email(conn, %{"token" => token}) do
    case Authentication.update_user_email(conn.assigns.current_user, token) do
      :ok ->
        conn
  ...
  defp assign_email_and_password_changesets(conn, _opts) do
    ...
    conn
    |> assign(:email_changeset, Authentication.change_user_email(user))
    |> assign(:password_changeset, Authentication.change_user_password(user))
  end
end
